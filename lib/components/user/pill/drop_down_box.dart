  ...
  Widget build(BuildContext context) {
    return DropdownButton<String>(
      ...
      items: items
          ...
          value: item,
          child: Text(item, style: Theme.of(context).textTheme.titleMedium!.copyWith(color: MyStyles.blackColor, fontSize: 16.sp))))
          .toList(),
      icon: Container(
        width: 21.w,
        height: 21.h,
        ...
        child: Icon(FontAwesomeIcons.chevronDown, color: MyStyles.whiteColor, size: 14.sp,),
      ),
